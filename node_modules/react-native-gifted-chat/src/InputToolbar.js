...
import { StyleSheet, View, Keyboard, ViewPropTypes, SafeAreaView } from 'react-native';
...
export default class InputToolbar extends React.Component {
  ...
  renderMenu() {
    ...
    } else if (this.props.onPressMenuButton) {
  ...
  render() {
    return (
      ...
      >
        <SafeAreaView style={[styles.primary, this.props.primaryStyle]}>
          {this.renderMenu()}
          {this.renderActions()}
          {this.renderComposer()}
          {this.renderSend()}
